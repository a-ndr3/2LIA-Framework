...
public class KafkaComplexListener extends AbstractMessageListener {
    ...
    private void processRecordsWithPerformanceCheck(ConsumerRecords<String, String> records) {
        ...
        System.out.printf("Size: %d, Inject Time: %d ms%n",
                size, injectDuration / 1_000_000);
    }
